...
// const inoculations = ['bordetella bronchiseptica', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'leptospirosis', 'rabies', 'calicivirus', 'viral rhinotracheitis', 'panleukopenia', 'parainfluenza', 'none', 'parvovirus', 'adenovirus', 'distemper']
...
// const arr= [111,222,333,444,555,666,777,888]

// const makearr = (arr) =>{
//   let arrTemp = []
//   let result =[]
//    for(let i = 0; i<3; i++){
//     arr.map(el=>arrTemp.push(el))
//     }
    
//     while(result.length<8){
//       let randomPosition = Math.floor(Math.random() * Math.floor(arrTemp.length))
//      let item = arrTemp.splice(randomPosition,1)[0]
...
// let randomPosition = Math.floor(Math.random() * Math.floor(arrTemp.length))
//    let item = arrTemp.splice(randomPosition,1)[0]
//    let res8 = result.slice(-8)
//    let res6 = result.slice(-6)
//    let res3 = result.slice(-3)
//    if(!res8.includes(item)&&!res6.includes(item)&&!res3.includes(item)){
//       result.push(item)
//      }
